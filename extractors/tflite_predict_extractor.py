    ...
    for spec in self._eval_config.model_specs:
      ...
      for i in input_details:
        ...
        for r in feature_rows:
          ...
          #print("value1:", value)
          #print('value1_shape=', value.shape)
          #print('value1_dtype=', value.dtype)

          # if value is None or np.any(np.equal(value, None)):
          #   default = -1 if input_type in [np.float32, np.int64, np.uint8] else ''
          ...
          value = np.reshape(value, input_shape)
          #print('value2=', value)
          #print('value2_shape=', value.shape)
          #print('value2_dtype=', value.dtype)


          ### start of customized function ###

          #value = value*255
          #value = value.astype(np.uint8)
          #print('value3=', value)
          #print('value3_shape=', value.shape)
          #print('value3_dtype=', value.dtype)
        ...
        #print("input_features[input_name]=", input_features[input_name])
        #print("np.shape(input_features[input_name])=", np.shape(input_features[input_name]))
        #print("tuple(i['shape'])=", tuple(i['shape']))
      ...
      for i in input_details:
        ...
        #print('input_name2=', input_name)
        #print('input_features[input_name]', input_features[input_name])

        #interpreter.set_tensor(i['index'], input_features[input_name])
        interpreter.set_tensor(i['index'], value)
